...
<body>
    <div class="top-menu d-flex align-items-center">
        <div class="d-flex justify-content-end mx-auto">
            <a href="<%= request.getContextPath() %>/main/login" class="top-menu-btn">로그인</a>
            <a href="<%= request.getContextPath() %>/main/register" class="top-menu-btn">회원가입</a>
        </div>
    </div>

    <!-- 헤더 영역 -->
    <header class="d-flex justify-content-between align-items-center mx-auto">
        <h3 class="fw-bold mb-0"><a href="<%= request.getContextPath() %>/main/baseball">스포츠 게시판</a></h3>
    ...
    <div id="container">
        ...
        <div id="menu">
            <div class="inner-menu h-100 mx-auto d-flex align-items-center">
                <a href="<%= request.getContextPath() %>/baseball" class="selected">야구</a>
        ...
        <div id="submenu" class="d-flex">
            ...
            <a href="<%= request.getContextPath() %>/videoList">영상목록</a>
            <a href="<%= request.getContextPath() %>/write">글쓰기</a>
            <a href="<%= request.getContextPath() %>/upload.html">영상올리기</a>
        </div>